...
def generate_wave(blast_name):
    ...
    FRAMES_FOLDER = f"demo/{BLAST_NAME}_output/{BLAST_NAME}_frames"
    OUTPUT_FOLDER = f"demo/{BLAST_NAME}_output/frames_wave"
    ...
    final_image_path = (
        f"demo/{BLAST_NAME}_output/{BLAST_NAME}_time_sequence_waves.jpg"
    )
    ...
    OUTPUT_IMAGE_PATH = (
        f"demo/{BLAST_NAME}_output/{BLAST_NAME}_time_sequence_waves_design_map.png"
    )
